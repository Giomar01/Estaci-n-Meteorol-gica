...
class PantallaLCD {
    ...
    public:
         ...
         */
        PantallaLCD(uint8_t lcdAddr, int columnas, int filas);

        /**
         * @brief Destructor de PantallaLCD.
         */
        ~PantallaLCD();
        
        /**
         * @brief Inicializa el hardware de la pantalla y enciende el backlight.
         */
        void inicializar();

        /**
         * @brief Borra todo el contenido impreso en la pantalla.
         */
        void limpiar();
